...
This file exists for tools that look for `CODEX.md` as an agent entrypoint. The authoritative agent entrypoint for this repository is [`AGENTS.md`](AGENTS.md).
